...
export const truthStore = [
  {
    id: "bio_01",
    topic: "Human Biology",
    false_statement: "Humans only use 10% of their brains.",
  ...
  },
  {
    id: "bio_02",
    topic: "Human Biology",
    false_statement: "Cracking your knuckles causes arthritis.",
  ...
  },
  {
    id: "chem_01",
    topic: "Chemistry",
    false_statement: "Gold is the most expensive metal on Earth.",
  ...
  },
  {
    id: "chem_02",
    topic: "Chemistry",
    false_statement: "All acids are dangerous and will burn anything they touch.",
  ...
  },
  {
    id: "phys_01",
    topic: "Physics",
    false_statement: "Heavier objects always fall faster than lighter ones.",
  ...
  },
  {
    id: "astro_01",
    topic: "Astronomy",
    false_statement: "The Great Wall of China is visible from space with the naked eye.",
  ...
  },
  {
    id: "geo_01",
    topic: "Geography",
    false_statement: "Africa is a country.",
  ...
  },
  {
    id: "geo_02",
    topic: "Geology",
    false_statement: "Diamonds form from compressed coal.",
  ...
  },
  {
    id: "hist_01",
    topic: "History",
    false_statement: "Napoleon Bonaparte was extremely short.",
  ...
  },
  {
    id: "hist_02",
    topic: "History",
    false_statement: "People in the Middle Ages believed the Earth was flat.",
  ...
  },
  {
    id: "lit_01",
    topic: "Literature",
    false_statement: "All dystopian novels predict the future accurately, so modern surveillance will definitely lead to totalitarian control.",
  ...
  },
  {
    id: "lit_02",
    topic: "Literature",
    false_statement: "If a story has an unreliable narrator, then everything in the story must be false.",
  ...
  },
  {
    id: "pol_01",
    topic: "Politics",
    false_statement: "If one policy fails, all policies from that political party must be bad.",
  ...
  },
  {
    id: "pol_02",
    topic: "Politics",
    false_statement: "You're either completely for this law or completely against progress.",
  ...
  },
  {
    id: "health_01",
    topic: "Health",
    false_statement: "You need to drink exactly 8 glasses of water a day.",
  ...
  },
  {
    id: "health_02",
    topic: "Health",
    false_statement: "Vitamin C prevents you from getting sick entirely.",
  ...
  },
  {
    ...
    false_statement: "More lines of code always mean a better program.",
  ...
  },
  {
    id: "cs_02",
    topic: "Computer Science",
    false_statement: "If an algorithm works once, it will always work for all inputs.",
